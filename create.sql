CREATE TABLE IF NOT EXISTS order_track_user(
    ...
    otu_create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY(otu_id)
...
CREATE TABLE IF NOT EXISTS order_track_order(
    ...
    oto_customer VARCHAR(32) NOT NULL,
    ...
    oto_finish_time TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
    oto_change_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    oto_create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY(oto_id),
    FOREIGN KEY(oto_customer)
        REFERENCES order_user(otu_user_name)
        ON DELETE RESTRICT
        ON UPDATE CASCADE
)ENGINE = MYISAM CHARACTER SET utf8mb4;
...
CREATE TABLE IF NOT EXISTS order_track_package(
    ...
    otp_create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY(otp_id)
)ENGINE = MYISAM CHARACTER SET utf8mb4;
...
CREATE TABLE IF NOT EXISTS order_track_product(
    ...
    otpr_create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY(otpr_id)
)ENGINE = MYISAM CHARACTER SET utf8mb4;

CREATE TABLE IF NOT EXISTS order_track_car(
    otc_id INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL,
    otc_plate VARCHAR(8) NOT NULL,
    otc_weight DECIMAL(10,2) NOT NULL,
    otc_price DECIMAL(10,2) NOT NULL,
    otc_type TINYINT NOT NULL,
    otc_is_active BOOLEAN NOT NULL,
    otc_change_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    otc_create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
)ENGINE = MYISAM CHARACTER SET utf8mb4;

CREATE TABLE IF NOT EXISTS order_track_transport(
    ott_id INT UNSIGNED UNIQUE AUTO_INCREMENT NOT NULL,
    ott_car_id INT NOT NULL,
    ott_order_detail_id INT NOT NULL,
    ott_change_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    ott_create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY(ott_id),
    FOREIGN KEY(ott_car_id)
        REFERENCES order_track_car(otc_id)
        ON DELETE RESTRICT
        ON UPDATE CASCADE,
    FOREIGN KEY(ott_order_detail_id)
